...
public:
	...
	uint16_t ui16GetMaxRssi(void)
	{
		return ui16MaxRssi;
	}
	uint16_t ui16GetMinRssi(void)
	{
		return ui16MinRssi;
	}
	uint8_t ui8GetChannel(void)
	{
		return ui8ActiveChannel;
	}
	uint8_t ui8GetReceiver(void)
	{
		return ui8ActiveReceiver;
	}
	uint8_t ui8GetDiversity(void)
	{
		return ui8ActiveDiversity;
	}
	uint8_t ui8ScanChannels(uint8_t ui8Set);
	void vCalibrateRssi(uint8_t ui8Mode);
	uint16_t *pui16GetAllRSSI(void)
	{
		return aui16Rssi;
	}
