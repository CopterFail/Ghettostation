...
static float        disarmed_time = 0.0;
...
static uint16_t     bearing;                        // Bearing value to home direction
...
// flight status
static uint8_t      flight_status = 0; // 0: first take off, 1: in flight, 2: landed not at home , 3: landed at home.
